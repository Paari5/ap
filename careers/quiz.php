...
$row= mysql_fetch_row($rs);
echo "<br/><br/><br/>";
echo "<form align=left style='margin-left:150px;' name=myfm method=post action=quiz.php>";
echo "<table width=100%> <tr> <td width=30>&nbsp;<td> <table border=0>";
$n=$_SESSION[qn]+1;
echo "<tR><td><span class=style2>Question ".  $n .": $row[2]</style>";
echo "<tr><td class=style8><input type=radio name=ans style='margin-top: 40px;' value=1>$row[3]";
