...
?>
 <table width="100%" border="0">
   <tr>
     <td width="132" rowspan="2" valign="top"><span class="style8"><img src="images/signup.jpg" width="131" height="155"></span> <BR/>
	 <a href="index.php">Back to login page</a></td>
   ...
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <table width="301" border="0" align="left">
         ...
         <tr>
           <td valign="top" class="style7">Resume</td>
           <td><input name="cv" type="file" accept="application/msword, application/vnd.ms-excel, application/pdf" id="cv">
		    <p><b>Note:</b><i>To upload only the ms word,ms excel and pdf (.doc, .pdf, .xls only) files.</i></p>
			</td>
